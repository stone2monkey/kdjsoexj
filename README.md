...
[Proxy]
🇭🇰 HK = ss, 156.234.142.191, 18277, encrypt-method=rc4-md5, password=YuanYang8964, tls=true, udp-relay=true

[Proxy Group]
Proxy = select, 🇭🇰 HK
Stream Services = select, 🇭🇰 HK
Domestic = select, DIRECT, 🇭🇰 HK
Apple Services = select, DIRECT, Domestic, 🇭🇰 HK
AD Block = select, REJECT, DIRECT, 🇭🇰 HK
...
[Script]
wb_ad = requires-body=true,script-path=https://ruleset.dev/wb_ad,script-update-interval=86400,type=http-response,pattern=^https?:\/\/(api|mapi)\.weibo\.(cn|com)\/2(\/groups\/timeline|\/statuses\/unread|\/statuses\/extend|\/comments\/build_comments|\/photo\/recommend_list|\/stories\/video_stream|\/statuses\/positives\/get|\/stories\/home_list|\/profile\/statuses|\/statuses\/friends\/timeline|\/service\/picfeed)
wb_launch = requires-body=true,script-path=https://ruleset.dev/wb_launch,script-update-interval=86400,type=http-response,pattern=^https?:\/\/(sdk|wb)app\.uve\.weibo\.com(\/interface\/sdk\/sdkad.php|\/wbapplua\/wbpullad.lua)
Aweme = requires-body=1,script-update-interval=86400,script-path=https://ruleset.dev/Aweme,type=http-response,pattern=^https://[\s\S]*\/aweme/v1/(feed|aweme/post|follow/feed)/
RRad = max-size=524288,requires-body=true,script-path=https://ruleset.dev/RRad,script-update-interval=86400,type=http-response,pattern=^https:\/\/api\.rr\.tv[\s\S]*(channel|Feed|Choice|profile|Medal)
# Onewayticket255
zhihu_feed = requires-body=1,max-size=0,script-path=https://ruleset.dev/zhihu_feed,script-update-interval=86400,type=http-response,pattern=https://api.zhihu.com/moments\?(action|feed_type)
zhihu_recommend = requires-body=1,max-size=0,script-path=https://ruleset.dev/zhihu_recommend,script-update-interval=86400,type=http-response,pattern=https://api.zhihu.com/topstory/recommend
zhihu_answer = requires-body=1,max-size=0,script-path=https://ruleset.dev/zhihu_answer,script-update-interval=86400,type=http-response,pattern=https://api.zhihu.com/.*/questions
zhihu_market = requires-body=1,max-size=0,script-path=https://ruleset.dev/zhihu_market,script-update-interval=86400,type=http-response,pattern=https://api.zhihu.com/market/header
surge3_zhihu_people = requires-body=1,max-size=0,script-path=https://ruleset.dev/surge3_zhihu_people,script-update-interval=86400,type=http-response,pattern=https://api.zhihu.com/people/
bilibili_rank = requires-body=1,max-size=0,script-path=https://ruleset.dev/bilibili_rank,script-update-interval=86400,type=http-response,pattern=https://app.bilibili.com/x/v2/rank
bilibili_space = requires-body=1,max-size=0,script-path=https://ruleset.dev/bilibili_space,script-update-interval=86400,type=http-response,pattern=https://app.bilibili.com/x/v2/space\?access_key
bilibili_tab = requires-body=1,max-size=0,script-path=https://ruleset.dev/bilibili_tab,script-update-interval=86400,type=http-response,pattern=https://app.bilibili.com/x/resource/show/tab\?access_key
bilibili_feed = requires-body=1,max-size=0,script-path=https://ruleset.dev/bilibili_feed,script-update-interval=86400,type=http-response,pattern=https://app.bilibili.com/x/v2/feed/index\?access_key
bilibili_account = requires-body=1,max-size=0,script-path=https://ruleset.dev/bilibili_account,script-update-interval=86400,type=http-response,pattern=https://app.bilibili.com/x/v2/account/mine\?access_key
bilibili_relate = requires-body=1,max-size=0,script-path=https://ruleset.dev/bilibili_relate,script-update-interval=86400,type=http-response,pattern=https://app.bilibili.com/x/v2/view\?access_key
bilibili_hot = requires-body=1,max-size=0,script-path=https://ruleset.dev/bilibili_hot,script-update-interval=86400,type=http-response,pattern=https://app.bilibili.com/x/v2/show/popular/index\?access_key
bilibili_reply = requires-body=1,max-size=0,script-path=https://ruleset.dev/bilibili_reply,script-update-interval=86400,type=http-response,pattern=https://api.bilibili.com/x/v2/reply/main\?access_key
bilibili_live = requires-body=1,max-size=0,script-path=https://ruleset.dev/bilibili_live,script-update-interval=86400,type=http-response,pattern=https://api.live.bilibili.com/xlive/app-room/v1/index/getInfoByRoom\?access_key
...
# rixCloud
surge3_abematv_web = requires-body=1,max-size=-1,script-path=https://ruleset.dev/surge3_abematv_web,script-update-interval=86400,type=http-response,pattern=https://abema.tv/.*
